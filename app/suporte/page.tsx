...
export default function SuportePage(){
 ...
 const openChat=(seed?:string)=>{const hello=`Olá${firstName?', '+firstName:''}. Sou o Léo, do suporte NOZA. Vou entender o que está acontecendo e conduzir o diagnóstico com você.`;setChat(items=>items.length?items:[{from:'leo',text:hello}]);setChatOpen(true);if(seed){setChat(items=>[...items,{from:'leo',text:supportReply(seed)+' Me conte exatamente o que está acontecendo para continuarmos.'}])}};
