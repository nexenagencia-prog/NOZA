...
import {BarChart3,Bell,BrainCircuit,Calculator,CalendarDays,Camera,ChevronLeft,ChevronRight,CirclePlus,DoorOpen,Grid2X2,Hexagon,Headphones,Menu,NotebookPen,Orbit,Pencil,Presentation,Sparkles,StickyNote,UserRound,Video,X} from 'lucide-react';
...
export default function AppSidebar({name='Sandro Bello',planLabel='NOZA Pro',avatarUrl=null,labels=defaults,onCalculator,onAnotar,onExpandedChange}:Props){
  ...
  const hiddenLabels=new Set(['Agenda','Skills','Anotar','Anotações','Criar slides','Planos e Preços','Preços e Planos','Contatos','Gravações','Calculadora','Reuniões','Notificações']);
