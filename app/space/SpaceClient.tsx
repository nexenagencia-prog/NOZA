  ...
  return <main className="app-shell space-page">
    ...
    <section className="content space-content">
      ...
      <div className="space-workspace">
        <div className="space-meeting-skills-row"><button className="space-meeting-skills-btn" onClick={()=>router.push('/skills')}><BrainCircuit/><span>Skills da reunião</span></button></div>
