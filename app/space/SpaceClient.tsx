...
export default function SpaceClient(){
  ...
  return <main className="app-shell space-page">
    ...
    <section className="content space-content">
      <AppTopbar/>
      <div className={`space-workspace ${collapsed.slides?'slides-collapsed ':''}${collapsed.agenda?'agenda-collapsed ':''}${collapsed.notes?'notes-collapsed':''}`}>
