...
export default function MeetingSkillsPage(){
  return <main className="app-shell skills-page meeting-skills-page">
    ...
    <style jsx global>{`
      ...
      .meeting-skills-scroll>.skills-site-content .skills-stage{width:min(1180px,100%)!important;max-width:1180px!important;min-width:0!important;box-sizing:border-box!important;margin-left:auto!important;margin-right:auto!important}
