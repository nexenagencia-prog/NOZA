...
export default function MeetingSkillsPage(){
  return <main className="app-shell skills-page meeting-skills-page">
    ...
    <style jsx global>{`
      ...
      .meeting-skills-scroll>.skills-site-content{margin-left:0!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:27px 36px 18px!important;overflow:hidden!important}
      .meeting-skills-scroll>.skills-site-content .skills-stage{width:100%!important;max-width:1320px!important;min-width:0!important;box-sizing:border-box!important;margin:0 auto!important;transform:none!important}
