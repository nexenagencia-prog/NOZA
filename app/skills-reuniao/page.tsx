...
export default function MeetingSkillsPage(){
  return <main className="app-shell skills-page meeting-skills-page">
    ...
    <style jsx global>{`
      ...
      .meeting-skills-scroll>.skills-site-content .skills-stage{width:calc(100% - 96px)!important;max-width:1320px!important;min-width:0!important;box-sizing:border-box!important;margin-left:auto!important;margin-right:auto!important}
