...
export default function MeetingSkillsPage(){
  return <main className="app-shell skills-page meeting-skills-page">
    ...
    <style jsx global>{`
      ...
      .meeting-skills-scroll>.skills-site-content{margin-left:0!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:0 36px!important;overflow:hidden!important}
